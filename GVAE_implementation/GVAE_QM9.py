...
train_dataset = QM9("/home/nesara/Project_CLESS/Dummy/MolCLR/data_pygeo/data_pygeo_QM9")[:80000]
test_dataset = QM9("/home/nesara/Project_CLESS/Dummy/MolCLR/data_pygeo/data_pygeo_QM9")[80000:90000]
...
def run_one_epoch(data_loader, type, epoch, kl_beta):
    ...
    for _, batch in enumerate(tqdm(data_loader)):
        ...
        try:
            ...
            edge_targets = batch.edge_attr.float()
            node_targets = batch.x.float()
            ...
            print(edge_targets.shape, triu_logits.shape, 'Edge Target Vs Logits')
            print(node_targets.shape, node_logits.shape,'Node Target Vs Logits')
